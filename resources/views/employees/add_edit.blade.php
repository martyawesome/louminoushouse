    ...
    <div class="col-md-4 col-xs-12">
      <div class="box-body">
        ...
        <div class="form-group{{ $errors->has('middle_name') ? ' has-error' : '' }}">
          ...
          {!! Form::text('middle_name', $employee->middle_name, ['class' => 'form-control']) !!}
    ...
    <div class="col-md-4 col-xs-12">
      <div class="box-body">
        ...
        <div class="form-group {{ $errors->has('birthdate') ? ' has-error' : '' }}">
          ...
          {!! Form::text('birthdate', $employee->birthdate, ['class' => 'form-control pull-right', 'style' => 'margin-bottom:10px;']) !!}
        ...
        <div class="form-group{{ $errors->has('contact_number') ? ' has-error' : '' }}">
          ...
          <div class="input-group">
              ...
              <input type="text" class="form-control" name="contact_number" value="{!! $employee->contact_number !!}" data-inputmask='"mask": "09999999999"' data-mask>
          </div>
